                            ...
                            @foreach($products as $product)
                                <div class="single-product">
                                    <div class="product-f-image">
                                        <img src="{{$product->image}}" alt="" style="height: 250px; width: 250px;">
                                        <div class="product-hover">
                                            <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i>
                                                Add to cart
                                            </a>
                                            <a href="{{route('details.product',['id'=>$product->id])}}"
                                    ...
                                    <h2>
                                        <a href="{{route('details.product',['id'=>$product->id])}}">{{$product->name}}</a>
                                    </h2>
